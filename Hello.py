...
st.markdown(
    ...
    **👈 Select a demo from the sidebar** to see some examples of what Streamlit can do!
    ...
    - Use a neutral net to [analyze the Udacity Self-driving Car Image Dataset](https://github.com/streamlit/demo-self-driving)
    - Explore a [New York City rideshare dataset](https://github.com/streamlit/denmo-uber)
    """
)
